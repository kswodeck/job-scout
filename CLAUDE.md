...
| `.github/workflows/scout.yml` | Every-other-day cron `0 9 */2 * *` (odd days of the month, 4:00am CDT / 3:00am CST; back-to-back runs on the 31st→1st of 31-day months; GitHub often fires 1–2h late on quiet repos; nightly until 2026-07-22), installs Claude Code CLI, runs scout, commits `data/`, opens issue |
