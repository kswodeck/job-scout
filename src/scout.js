...
const { fetchRemotive, fetchRemoteOK, fetchWWR, fetchChristianTechJobs, fetchHN, fetchATSBoards, scanForATSTokens } = require("./sources");
...
(async () => {
  ...
  if (src.christiantechjobs) tasks.push(["ctj", fetchChristianTechJobs(cfg, sinceMs)]);
